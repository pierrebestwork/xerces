...
// ---------------------------------------------------------------------------
void IGXMLScanner::processSchemaLocation(XMLCh* const schemaLoc, const XMLCh delim)
{
            ...
            while (*++locStr) 
                ...
                if (*locStr == 0xFFFF)
                    continue;
					 if (delim == chHTab)
					 {
						if (*locStr == chHTab)								// Bug#19491 - instead of using a space char as delimiter, use a horizontal tab char
							break;
					 }
					 else
					 {
